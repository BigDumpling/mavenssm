...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeCode() {
            $("#captcha_img").attr("src", "${pageContext.request.contextPath}/captcha/captcha-image?t="+genTimestamp());
        }
        function choose_bg() {
...
<div class="main_box">
    ...
    <div class="login_box">
        ...
        <div class="login_form">
            ...
            <form action="<%=path%>/login/index" id="login_form" method="post">
                <input type="hidden" name="jfinal_token" value="${jfinal_token }" />
                <c:if test="${!empty error}">${error.message}</c:if>
                ...
                <div class="form-group">
                    ...
                    <input id="j_captcha" value="" name="captcha" type="text" class="form-control x319 in">
                    <img id="captcha_img" src="${pageContext.request.contextPath}/captcha/captcha-image" alt="点击更换">
                </div>
